...
write_output("invoice", [
    ...
    invoice.billingInformation.address_line1,
    invoice.billing_information.address_line2,
    ...
    len(invoice.lines.data[0].metadata.travelers),
    ...
    len(invoice.lines.data[0].metadata.labels),
