...
write_output("invoice_lines", [
    ...
    len(lines.invoice_lines[0].metadata.travelers),
    ...
    len(lines.invoice_lines[0].metadata.labels),
    ...
    len(lines.invoice_lines[0].metadata.approvers),
